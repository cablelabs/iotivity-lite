...
static void
obt_so_16(oc_client_response_t *data)
{
...
static void
obt_so_15(oc_client_response_t *data)
{
  if (!oc_obt_is_otm_ctx_valid(data->user_data)) {
    return;
  }
  ...
  if (oc_init_post("/oic/sec/pstat", ep, NULL, &obt_so_16, HIGH_QOS, o)) {
...
obt_so_14(oc_client_response_t *data)
{
  ...
  oc_device_t *device = o->device;
  oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post("/oic/sec/acl2", ep, NULL, &obt_so_15, HIGH_QOS, o)) {
...
obt_so_13(oc_client_response_t *data)
{
  ...
  oc_device_t *device = o->device;
  oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_do_delete("/oic/sec/acl2", ep, NULL, &obt_so_14, HIGH_QOS, o)) {
    return;
  }
...
obt_so_12(oc_client_response_t *data)
{
  ...
  oc_device_t *device = o->device;
  oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post("/oic/sec/pstat", ep, NULL, &obt_so_13, HIGH_QOS, o)) {
    oc_rep_start_root_object();
    oc_rep_set_object(root, dos);
...
obt_so_11(oc_client_response_t *data)
{
  ...
  oc_device_t *device = o->device;
  oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post("/oic/sec/doxm", ep, NULL, &obt_so_12, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
obt_so_10(oc_client_response_t *data)
{
  ...
  oc_device_t *device = o->device;
  oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post("/oic/sec/sdi", ep, NULL, &obt_so_11, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
#undef OXM_SO
   ...
   */
  if (oc_init_post("/oic/sec/cred", ep, NULL, &obt_so_10, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
obt_so_8(oc_client_response_t *data)
{
  ...
  oc_device_t *device = o->device;
  oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  if (oc_init_post("/oic/sec/pstat", ep, NULL, &obt_so_9, HIGH_QOS, o)) {
    oc_uuid_t *my_uuid = oc_core_get_device_id(0);
    char uuid[OC_UUID_LEN];
    oc_uuid_to_str(my_uuid, uuid, OC_UUID_LEN);
...
obt_so_7(oc_client_response_t *data)
{
  ...
  if (oc_init_post("/oic/sec/acl2", ep, NULL, &obt_so_8, HIGH_QOS, o)) {
    oc_uuid_t *my_uuid = oc_core_get_device_id(0);
    char uuid[OC_UUID_LEN];
    oc_uuid_to_str(my_uuid, uuid, OC_UUID_LEN);
...
obt_so_6(oc_client_response_t *data)
{
  ...
  if (oc_init_post("/oic/sec/doxm", ep, NULL, &obt_so_7, HIGH_QOS, o)) {
    oc_uuid_t *my_uuid = oc_core_get_device_id(0);
    char uuid[OC_UUID_LEN];
    oc_uuid_to_str(my_uuid, uuid, OC_UUID_LEN);
...
obt_so_5(oc_client_response_t *data)
{
  ...
  if (oc_init_post("/oic/sec/doxm", ep, NULL, &obt_so_6, HIGH_QOS, o)) {
    oc_rep_start_root_object();
...
obt_so_3(oc_client_response_t *data)
{
  ...
  /**  3) <Open-TLS-PSK>+post pstat om=4
   */
  oc_device_t *device = o->device;
  oc_endpoint_t *ep = oc_obt_get_secure_endpoint(device->endpoint);
  oc_tls_close_connection(ep);
  oc_tls_select_psk_ciphersuite();
  oc_tls_use_so_obt_psk_identity();
  if (oc_init_post("/oic/sec/pstat", ep, NULL, &obt_so_4, HIGH_QOS, o)) {
    oc_rep_start_root_object();
  ...
  /* TODO: Properly remove temporary PSK cred from OBT?
   * Requres credid to be known within this function
...
/*
  OTM sequence:
  1) provision PSK cred locally+get doxm
  2) post doxm oxmsel=5
  3) <Open-TLS-PSK>+post pstat om=4
                              ...
                              void *data)
{
  ...
  uint8_t decoded_cred[pin_len];
  memcpy(decoded_cred, pin, pin_len);
  int decoded_len = oc_base64_decode(decoded_cred, pin_len);
  if (decoded_len < 0) {
  ...
  uint8_t key[16];
  if (oc_tls_pbkdf2(decoded_cred, decoded_len, uuid, 1000, key, 16) != 0) {
    goto so_otm_failure;
  }
   ...
   */
  oc_endpoint_t *ep = oc_obt_get_unsecure_endpoint(device->endpoint);
  if (oc_do_get("/oic/sec/doxm", ep, NULL, &obt_so_2, HIGH_QOS, o)) {
    return 0;
  }
